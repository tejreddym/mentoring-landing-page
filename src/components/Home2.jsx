...
import NextGenChatBot from './NextGenChatBot'; // Import the new bot
...
const Home2 = () => { // Renamed component
    ...
    const currentLabel = options.find(o => o.value === worryValue)?.label || "What's your worry?";
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#F0F9FF] to-[#E0F2FE] grid grid-cols-1 md:grid-cols-2 overflow-hidden relative font-sans">
            ...
            <div className="relative flex items-center justify-center bg-gray-100/50 md:bg-transparent h-[50vh] md:h-auto w-full order-2">
                ...
                {/* Floating Bubbles (4 Active, Shuffling Pool of 8) */}
                {(() => {
                    const allMentors = [
                        "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&q=80&w=200&h=200",
                        "https://images.unsplash.com/photo-1627556592933-ffe99c1cd9eb?auto=format&fit=crop&q=80&w=200&h=200",
                        "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=200&h=200",
                    ...
                    return (
                        <>
                            {/* Top Left & Middle Left Areas */}
                            <RandomBubble
                                imagePool={allMentors}
                                delay={0}
                                allowedSlots={[{ top: '10%', left: '5%' }, { top: '5%', left: '10%' }, { top: '45%', left: '1%' }]}
                            />
                            {/* Top Right & Middle Right Areas */}
                            <RandomBubble
                                imagePool={allMentors}
                                delay={1.5}
                                allowedSlots={[{ top: '10%', right: '5%' }, { top: '5%', right: '10%' }, { top: '45%', right: '1%' }]}
                            />
                            {/* Bottom Left Area */}
                            <RandomBubble
                                imagePool={allMentors}
                                delay={3.0}
                                allowedSlots={[{ bottom: '15%', left: '5%' }, { bottom: '10%', left: '2%' }]}
                            />
                            {/* Bottom Right Area */}
                            <RandomBubble
                                imagePool={allMentors}
                                delay={4.5}
                                allowedSlots={[{ bottom: '15%', right: '5%' }, { bottom: '10%', right: '2%' }]}
                            />
                        </>
                    );
                })()}
