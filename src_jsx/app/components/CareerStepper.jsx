...
export function CareerStepper() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-orange-50 py-12 px-4">
        ...
        <div className="relative px-4">
          <div className="flex justify-between items-start gap-4 mb-12">
            ...
            return <div key={step.id} className="relative flex-1 flex flex-col items-center">
                  {/* Step Shape Container */}
                  <motion.div className="relative flex items-center justify-center flex-shrink-0 mb-6" animate={{
                ...
                damping: 20
                  ...
                  background: isPending ? 'rgba(229, 231, 235, 0.6)' : step.bgGradient,
                  opacity: isPending ? 0.4 : isActive ? 1 : 0.7,
                  ...
                  {index < steps.length - 1 && <motion.div className="absolute top-12 h-1 overflow-visible" animate={{
                ...
                duration: 0.5
                    ...
                    <motion.h3 animate={{
                  color: isActive ? step.color : isPending ? '#9CA3AF' : '#374151',
